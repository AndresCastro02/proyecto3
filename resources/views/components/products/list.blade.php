                                            ...
                                            <div class="product-m">
                                                <div class="product-m__thumb">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                        ...
                                                        <img class="aspect__img" src="{{ count($product->images) > 0 ? asset('images').'/'.$product->images[0]->url : 'http://www.losprincipios.org/images/default.jpg' }}"
                                                            alt=""></a>
                                                ...
                                                <div class="product-m__content">
                                                    ...
                                                    <div class="product-m__price">${{ (100 - $product->discount) * 0.01 * $product->price }}</div>
