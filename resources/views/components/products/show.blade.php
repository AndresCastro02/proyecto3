                ...
                <div class="col-lg-5">
                    ...
                    <div class="pd u-s-m-b-30">
                        <div class="slider-fouc pd-wrap">
                            ...
                            <span class="pd-text">Click para zoom</span>
                        </div>
                        ...
                        <div class="u-s-m-b-15">
                            <div class="pd-detail__rating gl-rating-style"><i class="fas fa-star"></i><i
                                ...
                                <span class="pd-detail__review u-s-m-l-4">
                                    ...
                                    <a data-click-scroll="#view-review">{{ $product->reviews }}</a></span>
                            </div>
                        </div>
                        <div class="u-s-m-b-15">
                            <div class="pd-detail__inline">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="pd-desc">
                                <div class="pd-tab__desc">
                                    ...
                                    <div class="u-s-m-b-30"><iframe src="{{ $product->video }}"
                                            ...
                                            <div class="rev-f1__review">
                                                <div class="review-o u-s-m-b-15">
                                                    <div class="review-o__info u-s-m-b-8">
                                                        ...
                                                        <span class="review-o__name">Andres Castro</span>
                                                    ...
                                                    <p class="review-o__text">Moto de materiales de poca calidad, economica y de buen rendiemiento, alcanza una velocidad limite de 150 siendo esta una excelente velocidad para su cilindraje.</p>
                                                </div>
                                                <div class="review-o u-s-m-b-15">
                                                    <div class="review-o__info u-s-m-b-8">
